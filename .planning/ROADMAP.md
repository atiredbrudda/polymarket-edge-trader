...
**Plans:**
- [ ] 07-01-PLAN.md — Schema migration (avg_exit_price) + BUY/SELL aggregation split
- [ ] 07-02-PLAN.md — FLAT-first resolution pass + extraction + CLV fix
- [ ] 07-03-PLAN.md — Tests: build-positions, resolve-positions, scoring metrics, integration
...
**Plans:**
- [ ] 08-01-PLAN.md — Schema migration (4 new signals columns) + convergence query enrichment
- [ ] 08-02-PLAN.md — Writer upsert update + detect.py wiring
- [ ] 08-03-PLAN.md — TDD integration tests (test_enrichment.py)
...
| 7 - FLAT Position Tracking | Not Started | 8 | 7 |
| 8 - Detect Enrichment | Not Started | 9 | 6 |
...
*Last updated: 2026-04-05 after Phase 8 plans created (detect enrichment)*
