...
class MarketEntity(Base):
    ...
    Stores team_a, team_b, tournament, game, and market_type extracted
    from Polymarket market questions. Used for entity-based scoring in Phase 23.
    """
    ...
    __table_args__ = (
        Index("ix_market_entities_condition_id", "condition_id", unique=True),
    )
